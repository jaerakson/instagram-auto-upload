## 2026-07-21 20:30 (집) — v2.3: 진행바 + 취소 + 캡션 스타일 태그
- 브랜치: main
- 완료:
  ...
  - **캡션에 [style] 섹션 추가**: 게시글에 스타일 프리셋 자동 포함 (4곳: create handleAutoAll, runStep, pipeline auto/manual)
- 현재 상태: **v2.3 완성. 캡션 구조: 캡션 → [image prompt] → [style] → 해시태그**
- 다음 할 일:
  - 모바일 반응형 개선
  - 성과 분석 페이지 동영상/이미지 비교 분석
- 관련 커밋: b7e40fa ~ f7c766c (3개 커밋)
